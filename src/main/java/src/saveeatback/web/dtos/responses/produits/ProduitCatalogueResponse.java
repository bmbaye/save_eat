...
@Getter
@Setter
public class ProduitCatalogueResponse {
    private String id;
    ...
    public static class Builder{
        ...
        public ProduitCatalogueResponse build(){return new ProduitCatalogueResponse(this);}

    }

    public static Builder builder(){return new Builder();}

    private ProduitCatalogueResponse(Builder builder){
        this.id =builder.id;
